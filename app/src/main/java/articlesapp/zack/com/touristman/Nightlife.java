...
public class Nightlife {
    ...
    public Nightlife(String nightlifeId, String nightlifeName, String nightlifeAddress ,String nightlifeUrl) {
    ...
    public String getNightlifeAddress() {return nightlifeAddress;}
